...
<div class="contact-methods">
  <div class="contact-card">
    ...
    <a href="mailto:{{ site.author.email }}" class="contact-link">{{ site.author.email }}</a>
  </div>
  ...
  <div class="contact-card">
    ...
    <a href="https://linkedin.com/in/{{ site.author.linkedin }}" target="_blank" rel="noopener" class="contact-link">linkedin.com/in/{{ site.author.linkedin }}</a>
  </div>
  ...
  <div class="contact-card">
    ...
    <a href="https://github.com/{{ site.author.github }}" target="_blank" rel="noopener" class="contact-link">github.com/{{ site.author.github }}</a>
  </div>
</div>
...
I'm actively seeking junior developer positions, particularly in:
